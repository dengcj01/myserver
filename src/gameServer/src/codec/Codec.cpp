...
bool Codec::encoderMessage(google::protobuf::Message *mess, const google::protobuf::Descriptor *desc, lua_State *l, int idx)
{
	...
	//logInfo("22222222222222222 %d",fieldCnt);
	for (int i = 0; i < fieldCnt; ++i)
	{
		const google::protobuf::FieldDescriptor *fieldDesc = desc->field(i);
		//logInfo("xxxxxxxxxxxx %s %d", fieldDesc->name().c_str(), fieldDesc->type());
		...
		uint8_t messageType = fieldDesc->cpp_type();
		int luaType = lua_type(l, lua_gettop(l));

		if(messageType == google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE && luaType == 0)
		{
		...
		if(fieldDesc->is_repeated() && luaType == 0)
		{
			//ps(l);	
...
bool Codec::encoderRepeatedField(google::protobuf::Message *mess, const google::protobuf::FieldDescriptor *fieldDesc, lua_State *l, int idx)
{
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_DOUBLE:
		...
		{
			reftion->AddDouble(mess, fieldDesc, 0);
		}
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_FLOAT:
		...
		{
			reftion->AddFloat(mess, fieldDesc, 0);
		}
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_INT32:
		...
		{
			reftion->AddInt32(mess, fieldDesc, 0);
		}
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_UINT32:
		...
		{
			reftion->AddUInt32(mess, fieldDesc, 0);
		}
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_INT64:
		...
		{
			reftion->AddInt64(mess, fieldDesc, 0);
		}
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_UINT64:
		...
		{
			reftion->AddUInt64(mess, fieldDesc, 0);
		}
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_ENUM:
		...
		{
			reftion->AddEnumValue(mess, fieldDesc, 0);
		}
		return true;
	case google::protobuf::FieldDescriptor::CPPTYPE_BOOL:
		...
		{
			reftion->AddBool(mess, fieldDesc, false);
		}
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_STRING:
	{
		...
		{
			reftion->AddString(mess, fieldDesc, "");
		}
...
bool Codec::encoderOptional(google::protobuf::Message *mess, const google::protobuf::FieldDescriptor *fieldDesc, lua_State *l, int idx)
{
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_DOUBLE:
		...
		{
			reftion->SetDouble(mess, fieldDesc, 0);
		}
		return true;
	case google::protobuf::FieldDescriptor::CPPTYPE_FLOAT:
		// if(valueType != LUA_TNUMBER)
		...
		{
			reftion->SetFloat(mess, fieldDesc, 0);
		}
		return true;
	case google::protobuf::FieldDescriptor::CPPTYPE_INT32:
		// if(valueType != LUA_TNUMBER)
		...
		{
			reftion->SetInt32(mess, fieldDesc, 0);
		}
	...
	case google::protobuf::FieldDescriptor::CPPTYPE_INT64:
		...
		{
			reftion->SetInt64(mess, fieldDesc, 0);
		}
		return true;
	case google::protobuf::FieldDescriptor::CPPTYPE_UINT32:
		// if(valueType != LUA_TNUMBER)
		...
		{
			reftion->SetUInt32(mess, fieldDesc, 0);
		}
		return true;
	case google::protobuf::FieldDescriptor::CPPTYPE_UINT64:
		// if(valueType != LUA_TNUMBER)
		...
		{
			reftion->SetUInt64(mess, fieldDesc, 0);
		}
		return true;
	case google::protobuf::FieldDescriptor::CPPTYPE_ENUM:
		// if(valueType != LUA_TNUMBER)
		...
		{
			reftion->SetEnumValue(mess, fieldDesc, 0);
		}
		return true;
	case google::protobuf::FieldDescriptor::CPPTYPE_BOOL:
		// if(valueType != LUA_TBOOLEAN)
		...
		{
			reftion->SetBool(mess, fieldDesc, false);
		}
		return true;
	case google::protobuf::FieldDescriptor::CPPTYPE_STRING:
	{
		...
		{
			reftion->SetString(mess, fieldDesc, "");
		}
