...
PROTOBUF_CONSTEXPR NotifyServerCloseClient::NotifyServerCloseClient(
    ::_pbi::ConstantInitialized)
  : code_(0u){}
struct NotifyServerCloseClientDefaultTypeInternal {
  PROTOBUF_CONSTEXPR NotifyServerCloseClientDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~NotifyServerCloseClientDefaultTypeInternal() {}
  union {
    NotifyServerCloseClient _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 NotifyServerCloseClientDefaultTypeInternal _NotifyServerCloseClient_default_instance_;
...
const uint32_t TableStruct_Login_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::NotifyServerCloseClient, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::NotifyServerCloseClient, code_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 64, -1, -1, sizeof(::NotifyServerCloseClient)},
};
...
uint8_t* ReqLoginAuth::_InternalSerialize(
  ...
  if (this->_internal_fromserverid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(5, this->_internal_fromserverid(), target);
  }
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "ReqCreatePlayer.name"));
        } else
          goto handle_unusual;
        continue;
      default:
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "ResCreatePlayer.name"));
        } else
          goto handle_unusual;
        continue;
      // uint64 pid = 3;
...
class NotifyServerCloseClient::_Internal {
 public:
};

NotifyServerCloseClient::NotifyServerCloseClient(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:NotifyServerCloseClient)
}
NotifyServerCloseClient::NotifyServerCloseClient(const NotifyServerCloseClient& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  code_ = from.code_;
  // @@protoc_insertion_point(copy_constructor:NotifyServerCloseClient)
}

inline void NotifyServerCloseClient::SharedCtor() {
code_ = 0u;
}

NotifyServerCloseClient::~NotifyServerCloseClient() {
  // @@protoc_insertion_point(destructor:NotifyServerCloseClient)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void NotifyServerCloseClient::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void NotifyServerCloseClient::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void NotifyServerCloseClient::Clear() {
// @@protoc_insertion_point(message_clear_start:NotifyServerCloseClient)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* NotifyServerCloseClient::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* NotifyServerCloseClient::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:NotifyServerCloseClient)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:NotifyServerCloseClient)
  return target;
}

size_t NotifyServerCloseClient::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:NotifyServerCloseClient)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData NotifyServerCloseClient::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    NotifyServerCloseClient::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*NotifyServerCloseClient::GetClassData() const { return &_class_data_; }

void NotifyServerCloseClient::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<NotifyServerCloseClient *>(to)->MergeFrom(
      static_cast<const NotifyServerCloseClient &>(from));
}


void NotifyServerCloseClient::MergeFrom(const NotifyServerCloseClient& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:NotifyServerCloseClient)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void NotifyServerCloseClient::CopyFrom(const NotifyServerCloseClient& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:NotifyServerCloseClient)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool NotifyServerCloseClient::IsInitialized() const {
  return true;
}

void NotifyServerCloseClient::InternalSwap(NotifyServerCloseClient* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(code_, other->code_);
}

::PROTOBUF_NAMESPACE_ID::Metadata NotifyServerCloseClient::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Login_2eproto_getter, &descriptor_table_Login_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::NotifyServerCloseClient*
Arena::CreateMaybeMessage< ::NotifyServerCloseClient >(Arena* arena) {
  return Arena::CreateMessageInternal< ::NotifyServerCloseClient >(arena);
}
