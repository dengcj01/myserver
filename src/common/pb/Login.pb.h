...
class NotifyServerCloseClient;
struct NotifyServerCloseClientDefaultTypeInternal;
extern NotifyServerCloseClientDefaultTypeInternal _NotifyServerCloseClient_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::NotifyServerCloseClient* Arena::CreateMaybeMessage<::NotifyServerCloseClient>(Arena*);
...
class NotifyServerCloseClient final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:NotifyServerCloseClient) */ {
 public:
  inline NotifyServerCloseClient() : NotifyServerCloseClient(nullptr) {}
  ~NotifyServerCloseClient() override;
  explicit PROTOBUF_CONSTEXPR NotifyServerCloseClient(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  NotifyServerCloseClient(const NotifyServerCloseClient& from);
  NotifyServerCloseClient(NotifyServerCloseClient&& from) noexcept
    : NotifyServerCloseClient() {
    *this = ::std::move(from);
  }

  inline NotifyServerCloseClient& operator=(const NotifyServerCloseClient& from) {
    CopyFrom(from);
    return *this;
  }
  inline NotifyServerCloseClient& operator=(NotifyServerCloseClient&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const NotifyServerCloseClient& default_instance() {
    return *internal_default_instance();
  }
  static inline const NotifyServerCloseClient* internal_default_instance() {
    return reinterpret_cast<const NotifyServerCloseClient*>(
               &_NotifyServerCloseClient_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(NotifyServerCloseClient& a, NotifyServerCloseClient& b) {
    a.Swap(&b);
  }
  inline void Swap(NotifyServerCloseClient* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(NotifyServerCloseClient* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  NotifyServerCloseClient* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<NotifyServerCloseClient>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const NotifyServerCloseClient& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const NotifyServerCloseClient& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(NotifyServerCloseClient* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "NotifyServerCloseClient";
  }
  protected:
  explicit NotifyServerCloseClient(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:NotifyServerCloseClient)
 private:
  class _Internal;
...
inline uint32_t ReqLoginAuth::_internal_serverid() const {
  return serverid_;
}
inline uint32_t ReqLoginAuth::serverid() const {
  // @@protoc_insertion_point(field_get:ReqLoginAuth.serverId)
  return _internal_serverid();
}
inline void ReqLoginAuth::_internal_set_serverid(uint32_t value) {
  
  serverid_ = value;
}
inline void ReqLoginAuth::set_serverid(uint32_t value) {
...
inline uint32_t ReqLoginAuth::_internal_fromserverid() const {
  return fromserverid_;
}
inline uint32_t ReqLoginAuth::fromserverid() const {
  // @@protoc_insertion_point(field_get:ReqLoginAuth.fromServerId)
  return _internal_fromserverid();
}
inline void ReqLoginAuth::_internal_set_fromserverid(uint32_t value) {
  
  fromserverid_ = value;
}
inline void ReqLoginAuth::set_fromserverid(uint32_t value) {
...
inline uint32_t ResLoginAuth::_internal_code() const {
  return code_;
}
inline uint32_t ResLoginAuth::code() const {
  // @@protoc_insertion_point(field_get:ResLoginAuth.code)
  return _internal_code();
}
inline void ResLoginAuth::_internal_set_code(uint32_t value) {
  
  code_ = value;
}
inline void ResLoginAuth::set_code(uint32_t value) {
...
inline uint32_t ResSelectPlayer::_internal_code() const {
  return code_;
}
inline uint32_t ResSelectPlayer::code() const {
  // @@protoc_insertion_point(field_get:ResSelectPlayer.code)
  return _internal_code();
}
inline void ResSelectPlayer::_internal_set_code(uint32_t value) {
  
  code_ = value;
}
inline void ResSelectPlayer::set_code(uint32_t value) {
  _internal_set_code(value);
...
inline uint32_t ReqCreatePlayer::_internal_sex() const {
  return sex_;
}
inline uint32_t ReqCreatePlayer::sex() const {
  // @@protoc_insertion_point(field_get:ReqCreatePlayer.sex)
  return _internal_sex();
}
inline void ReqCreatePlayer::_internal_set_sex(uint32_t value) {
  
  sex_ = value;
}
inline void ReqCreatePlayer::set_sex(uint32_t value) {
...
inline uint32_t ResCreatePlayer::_internal_sex() const {
  return sex_;
}
inline uint32_t ResCreatePlayer::sex() const {
  // @@protoc_insertion_point(field_get:ResCreatePlayer.sex)
  return _internal_sex();
}
inline void ResCreatePlayer::_internal_set_sex(uint32_t value) {
  
  sex_ = value;
}
inline void ResCreatePlayer::set_sex(uint32_t value) {
  _internal_set_sex(value);
...
inline uint32_t ResCreatePlayer::_internal_code() const {
  return code_;
}
inline uint32_t ResCreatePlayer::code() const {
  // @@protoc_insertion_point(field_get:ResCreatePlayer.code)
  return _internal_code();
}
inline void ResCreatePlayer::_internal_set_code(uint32_t value) {
  
  code_ = value;
}
inline void ResCreatePlayer::set_code(uint32_t value) {
  _internal_set_code(value);
...
inline uint32_t ResEnterGame::_internal_code() const {
  return code_;
}
inline uint32_t ResEnterGame::code() const {
  // @@protoc_insertion_point(field_get:ResEnterGame.code)
  return _internal_code();
}
inline void ResEnterGame::_internal_set_code(uint32_t value) {
  
  code_ = value;
}
inline void ResEnterGame::set_code(uint32_t value) {
  _internal_set_code(value);
...
// uint32 code = 1;
inline void NotifyServerCloseClient::clear_code() {
  code_ = 0u;
}
inline uint32_t NotifyServerCloseClient::_internal_code() const {
  return code_;
}
inline uint32_t NotifyServerCloseClient::code() const {
  // @@protoc_insertion_point(field_get:NotifyServerCloseClient.code)
  return _internal_code();
}
inline void NotifyServerCloseClient::_internal_set_code(uint32_t value) {
  
  code_ = value;
}
inline void NotifyServerCloseClient::set_code(uint32_t value) {
  _internal_set_code(value);
  // @@protoc_insertion_point(field_set:NotifyServerCloseClient.code)
}
